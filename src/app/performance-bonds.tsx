              ...
              <ScrollView style={styles.tableBody} showsVerticalScrollIndicator={false}>
                {filtered.map((b) => (
                  <View key={b.id} style={styles.tableRow}>
                    ...
                    <Text style={[styles.rowCell, { width: 120 }]} numberOfLines={1}>{b.date}</Text>
                    <Text style={[styles.rowCell, { width: 150 }]} numberOfLines={2}>{b.description}</Text>
          ...
          <View style={styles.formOverlay}>
            <View style={[styles.formCard, { backgroundColor: theme.backgroundElement }]}>
              ...
              <ScrollView style={styles.formBody} showsVerticalScrollIndicator={false}>
                ...
                <TextInput style={[styles.textInput, { color: theme.text, borderColor: theme.backgroundSelected }]} placeholder="e.g. 2025-12-31" placeholderTextColor={theme.textSecondary} value={formValues.date} onChangeText={(v) => setFormValues((p) => ({ ...p, date: v }))} />
...
const createStyles = (theme: ReturnType<typeof useTheme>) => StyleSheet.create({
  ...
  formOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', zIndex: 100 },
