...
export default function BooksPage() {
  ...
  const renderList = (items: { id: number; name: string }[], onSelect: (item: any) => void, emptyMsg: string) => {
    ...
    return (
      <ScrollView style={{ flex: 1, width: "100%", overscrollBehavior: 'none' } as any} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false} bounces={false} overScrollMode="never">
        {items.map((item) => (
  ...
  const renderImages = () => {
    ...
    return (
      <View style={{ flex: 1, width: "100%" }}>
        ...
        <ScrollView style={{ flex: 1, overscrollBehavior: 'none' } as any} contentContainerStyle={styles.feedScrollContent} showsVerticalScrollIndicator={false} bounces={false} overScrollMode="never">
